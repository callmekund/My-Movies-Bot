...
PICS_URL = (environ.get('PICS_URL', 'https://api.aniwallpaper.workers.dev/random?type=nature')).split() #random anime girl img each time from aniwallpaper (Experimental)
